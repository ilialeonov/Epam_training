...
public class Validator {
    ...
    private static final String MAIL_STRING_PATTERN 
            = "(\\w{5,})@(\\w+\\.)([a-z]{2,6})";
    private static final String STATUS_PATTERN = "Yes|No";
    ...
    private static final Pattern PATTERN_STATUS
            = Pattern.compile(STATUS_PATTERN);
    ...
    public static boolean createCriminalDataIsValid(String name, String panname, 
            ...
            String award, String information, String status) {
        LOG.debug("checking if register datas are valid");
        ...
        if (information == null || name == null || panname == null || age == null
            ...
            Matcher matcherStatus = PATTERN_STATUS.matcher(status);
